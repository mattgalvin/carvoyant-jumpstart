module PreorderHelper
  def like_button(width = 70, show_faces = false)
    raw "<div class=\"fb-like\" data-href=\"https://www.facebook.com/CARVOYANT\" data-send=\"false\" data-width=\"#{width}\" data-layout=\"button_count\" data-show-faces=\"#{show_faces}\"></div>"
  end
  def pin_it_button
